...
const api: MetriaApi = {
  ...
  onWidgetReveal: (callback: () => void) => { ipcRenderer.on("metria:widget-reveal", () => callback()); },
  onWidgetCollapse: (callback: () => void) => { ipcRenderer.on("metria:widget-collapse", () => callback()); },
  setWidgetHoverState: (hovered: boolean) => ipcRenderer.invoke("metria:widget-hover-state", hovered),
